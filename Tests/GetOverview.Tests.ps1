...
Describe -Tags "Example" "Get-RabbitMQOverview" {
    ...
    It "should get server overview" {
        ...
        $actual = Get-RabbitMQOverview -HostName $server | select -ExpandProperty HostName
    ...
    It "should get overview for several servers" {
        ...
        $actual = Get-RabbitMQOverview -HostName $server, $server | select -ExpandProperty HostName
