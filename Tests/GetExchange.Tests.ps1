...
Describe -Tags "Example" "Get-RabbitMQExchange" {
    ...
    It "should get Exchanges registered with the server" {
        ...
        $actual = Get-RabbitMQExchange -HostName $server | select -ExpandProperty name 
    ...
    It "should get Exchanges filtered by name" {
        ...
        $actual = Get-RabbitMQExchange -HostName $server -Name "amq.*" | select -ExpandProperty name | Sort-Object | Get-Unique 
    ...
    It "should get Exchange names to filter by from the pipe" {
        ...
        $actual = $('amq.direct', 'amq.fanout') | Get-RabbitMQExchange -HostName $server | select -ExpandProperty name | Sort-Object | Get-Unique 
